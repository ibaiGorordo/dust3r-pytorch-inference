...
from dust3r import Dust3r, preprocess, postprocess
...
pts1, conf_map1, depth_map1, mask1 = postprocess(pt1, cf1)
pts2, conf_map2, depth_map2, mask2 = postprocess(pt2, cf2)
